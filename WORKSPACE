new_http_archive(
  ...
  build_file = "compilers/gcc-arm-linux-gnueabihf-7.4.1.BUILD",
  urls = ["https://releases.linaro.org/components/toolchain/binaries/latest-7/arm-linux-gnueabihf/gcc-linaro-7.4.1-2019.02-x86_64_arm-linux-gnueabihf.tar.xz"],
